    ...
    public static ImageListener getImageListener(final String url,final ImageView view,
        ...
        return new ImageListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                if (errorImageResId != 0) {
                	...
                	if(file.exists()){
                		...
                		if(bmp!=null){
                			TransitionDrawable td = new TransitionDrawable(new Drawable[]{new ColorDrawable(Color.LTGRAY),new BitmapDrawable(bmp)}); 
           ...
           /* @Override
            ...
            public void onResponse(ImageContainer response, boolean isImmediate) {
                if (response.getBitmap() != null) {
                	 TransitionDrawable td = new TransitionDrawable(new Drawable[]{new ColorDrawable(Color.LTGRAY),new BitmapDrawable(response.getBitmap())}); 
                		td.setCrossFadeEnabled(true);
                		view.setScaleType(ScaleType.CENTER_CROP);
                		view.setImageDrawable(td);
