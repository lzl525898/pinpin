...
public class BadgeView extends TextView {
	...
	private static final int  DEFAULT_TB_PADDING_DIP = 0;
	...
	private int badgeTBPadding;
	private int badgeLRPadding;
	...
	private void init(Context context, View target, int tabIndex) {
		...
		badgeLRPadding = dipToPixels(DEFAULT_LR_PADDING_DIP);
		  badgeTBPadding = dipToPixels(DEFAULT_TB_PADDING_DIP);
	...
	private void show(boolean animate, Animation anim) {
		setPadding(badgeLRPadding, badgeTBPadding, badgeLRPadding, badgeTBPadding);
	...
	public void setBadgeTBPadding(int p) {
		this.badgeTBPadding = p;
	}
	public void setBadgeLRPadding(int p) {
		this.badgeLRPadding = p;
	}
	/**
