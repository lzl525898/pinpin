package com.pinpin.view.lorentzos.flingswipe;
...
private int i;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.e("onLayout","adapterCount="+adapterCount);
        if(adapterCount == 0) {
    ...
    private void makeAndAddView(View child) {
        ...
        lp.setMargins(i*4,0,i*4, adapterCount*4-i*4);
        i+=1;
        if(i==adapterCount){
        	i=0;
                ...
                flingCardListener = new FlingCardListener(mActiveCard, mAdapter.getItem(0),
                        ROTATION_DEGREES, new FlingCardListener.FlingListener() {
                            ...
                            public void onCardExited() {
                                ...
                                if(mAdapter!=null&&mAdapter.getCount() <= MIN_ADAPTER_STACK) mFlingListener.onAdapterAboutToEmpty(mAdapter.getCount());
                            }
